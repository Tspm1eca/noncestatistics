...
void cmd_help(){
    ...
    printf("Getting a lot of ApNonces from various devices and firmware versions\n\n");
    printf("  -h, --help             prints usage information\n");
    printf("  -e, --ecid ECID        manually specify ECID of the device. Uses any device, if it is not specified\n");
    printf("  -t, --times amount     speficy how many ApNonces are collected. If it not specified, it will collect ApNonces until you enter using CTRL+C\n");
    printf("  -a, --abort            resets device to normal mode\n");
    printf("  -s, --statistics FILE  print statistics from nonces.txt file\n");
    ...
    printf("Do statistics on the ApNonces collected in nonces.txt\n");
...
int main(int argc, const char * argv[]) {
    ...
    if (!only_abort) {
        ...
        switch (client->mode->index) {
            case MODE_NORMAL:
                info("in normal mode... Trying to get in recovery mode...\n");
    ...
    std::cout << "Resetting auto-boot..." << std::endl;
